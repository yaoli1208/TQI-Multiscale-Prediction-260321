...
RESULTS_DIR = f'{BASE_DIR}/results/baseline_50_lightweight'
...
print(f"\n{'='*80}")
print(f"前50样本基线对比 - 轻量版 (去掉Holt-Winters)")
print(f"方法: 历史均值、移动平均、Trident v1/v2/v2.1")
...
print(f"{'样本':<8} {'历史均值':<10} {'移动平均':<10} {'v1':<8} {'v2':<8} {'v2.1':<8} {'最佳':<15}")
print("="*75)
...
df_results.to_csv(f'{RESULTS_DIR}/lightweight_comparison.csv', index=False)
...
print(f"结果保存: {RESULTS_DIR}/lightweight_comparison.csv")
print(f"{'='*80}")
